package com.jackson.apiinterface.utils;

import cn.hutool.http.HttpRequest;
import com.jackson.apiclientsdk.exception.ApiException;
import com.jackson.apiclientsdk.exception.StatusCode;
    ...
    public static <T> String buildUrl(String baseUrl, T params) throws ApiException {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                throw new ApiException(StatusCode.OPERATION_ERROR, "构建url异常");
            }
        }
        return url.toString();
    }
