...
import com.jackson.api.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.jackson.api.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.jackson.api.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.jackson.api.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.jackson.api.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    static {
        map = new HashMap<>();
        map.put(1L, "getPoisonousChickenSoup");
        map.put(2L, "getWeiboHotSearch");
        map.put(3L, "getRandomWallpaper");
    }
    ...
    public BaseResponse<Long> addInterfaceInfo(@RequestBody InterfaceInfoAddRequest interfaceInfoAddRequest,
        ...
        // 调用 save() 方法后，已经将接口 id 赋值给了 interfaceInfo 对象，不需要再从数据库读取
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        if (userRequestParams == null || userRequestParams.length() == 0) {
            userRequestParams = "{}";
        }
        // 判断是否存在
        InterfaceInfo oldInterfaceInfo = interfaceInfoService.getById(id);
        ...
        if (oldInterfaceInfo.getStatus() == InterfaceInfoStatusEnum.OFFLINE.getValue()) {
            throw new BusinessException(StatusCode.PARAMS_ERROR, "接口已关闭");
        }
        User loginUser = userService.getLoginUser(request);
        ...
        String result;
        try {
            Method method = tempClient.getClass().getMethod(map.get(id), String.class);
            result = (String) method.invoke(tempClient, userRequestParams);
        } catch (Exception e) {
